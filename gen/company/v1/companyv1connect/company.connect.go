...
const (
	...
	// CompanyServiceGetCompanyMetricsProcedure is the fully-qualified name of the CompanyService's
	// GetCompanyMetrics RPC.
	CompanyServiceGetCompanyMetricsProcedure = "/company.v1.CompanyService/GetCompanyMetrics"
)
...
type CompanyServiceClient interface {
	...
	GetCompanyMetrics(context.Context, *connect.Request[v1.GetCompanyMetricsRequest]) (*connect.Response[v1.GetCompanyMetricsResponse], error)
}
...
func NewCompanyServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CompanyServiceClient {
	...
	return &companyServiceClient{
		...
		getCompanyMetrics: connect.NewClient[v1.GetCompanyMetricsRequest, v1.GetCompanyMetricsResponse](
			httpClient,
			baseURL+CompanyServiceGetCompanyMetricsProcedure,
			connect.WithSchema(companyServiceMethods.ByName("GetCompanyMetrics")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type companyServiceClient struct {
	...
	getCompanyMetrics *connect.Client[v1.GetCompanyMetricsRequest, v1.GetCompanyMetricsResponse]
}
...
// GetCompanyMetrics calls company.v1.CompanyService.GetCompanyMetrics.
func (c *companyServiceClient) GetCompanyMetrics(ctx context.Context, req *connect.Request[v1.GetCompanyMetricsRequest]) (*connect.Response[v1.GetCompanyMetricsResponse], error) {
	return c.getCompanyMetrics.CallUnary(ctx, req)
}
...
func NewCompanyServiceHandler(svc CompanyServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	companyServiceGetCompanyMetricsHandler := connect.NewUnaryHandler(
		CompanyServiceGetCompanyMetricsProcedure,
		svc.GetCompanyMetrics,
		connect.WithSchema(companyServiceMethods.ByName("GetCompanyMetrics")),
		connect.WithHandlerOptions(opts...),
	)
	return "/company.v1.CompanyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case CompanyServiceGetCompanyMetricsProcedure:
			companyServiceGetCompanyMetricsHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedCompanyServiceHandler) GetCompanyMetrics(context.Context, *connect.Request[v1.GetCompanyMetricsRequest]) (*connect.Response[v1.GetCompanyMetricsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("company.v1.CompanyService.GetCompanyMetrics is not implemented"))
}
