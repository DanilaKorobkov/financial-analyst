...
// тип бумаги, уровень листинга. Источник данных — блок description
// эндпоинта /iss/securities/{TICKER}.json публичного REST API MOEX ISS.
...
// ListingLevel — котировальный уровень MOEX. UNSPECIFIED означает,
// что биржа не указала уровень (поле LISTLEVEL отсутствовало в ответе).
...
const file_company_v1_company_proto_rawDesc = "" +
	...
	"\rlisting_level\x18\x05 \x01(\x0e2\x18.company.v1.ListingLevelR\flistingLevel*\x96\x01\n" +
	...
	"\x13LISTING_LEVEL_THIRD\x10\x032]\n" +
...
var file_company_v1_company_proto_depIdxs = []int32{
	...
	2, // 3: company.v1.CompanyService.GetCompany:input_type -> company.v1.GetCompanyRequest
	3, // 4: company.v1.CompanyService.GetCompany:output_type -> company.v1.GetCompanyResponse
