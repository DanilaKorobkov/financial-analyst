...
| `insider`          | str                 | Имя/название инсайдера (физлицо, аффилированное юридическое лицо, эмитент при выкупе). `"Информация не раскрывается"` — данные скрыты по требованию ЦБ.                |
